...
{
    public partial class MediaFeederDataContext : DbContext
    {
        public MediaFeederDataContext()
        {
        }

        public MediaFeederDataContext(DbContextOptions<MediaFeederDataContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<DjangoCeleryResultsChordcounter> DjangoCeleryResultsChordcounters { get; set; }
        public virtual DbSet<DjangoCeleryResultsGroupresult> DjangoCeleryResultsGroupresults { get; set; }
        public virtual DbSet<DjangoCeleryResultsTaskresult> DjangoCeleryResultsTaskresults { get; set; }
        ...
        public virtual DbSet<DynamicPreferencesGlobalpreferencemodel> DynamicPreferencesGlobalpreferencemodels { get; set; }
        public virtual DbSet<DynamicPreferencesUsersUserpreferencemodel> DynamicPreferencesUsersUserpreferencemodels { get; set; }
        ...
        public virtual DbSet<YtManagerAppJobexecution> YtManagerAppJobexecutions { get; set; }
        public virtual DbSet<YtManagerAppJobmessage> YtManagerAppJobmessages { get; set; }
        public virtual DbSet<YtManagerAppSubscription> YtManagerAppSubscriptions { get; set; }
        public virtual DbSet<YtManagerAppSubscriptionFolder> YtManagerAppSubscriptionFolders { get; set; }
        public virtual DbSet<YtManagerAppVideo> YtManagerAppVideos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Host=localhost;Database=ytsm;Username=ytsm;Password=verysecurepassword;port=5432");
            }
        }

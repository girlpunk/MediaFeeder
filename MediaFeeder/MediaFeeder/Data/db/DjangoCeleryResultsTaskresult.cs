...
public class DjangoCeleryResultsTaskresult
{
    ...
    [MaxLength(255)] public string TaskId { get; set; }

    [MaxLength(50)] public string Status { get; set; }

    [MaxLength(128)] public string ContentType { get; set; }

    [MaxLength(64)] public string ContentEncoding { get; set; }
    ...
    [MaxLength(255)] public string TaskName { get; set; }

    [MaxLength(100)] public string Worker { get; set; }

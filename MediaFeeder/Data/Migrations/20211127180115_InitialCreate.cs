...
namespace MediaFeeder.Data.Migrations
{
    public partial class InitialCreate : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "wfc");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_joined = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("auth_user_pkey", x => x.id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("django_celery_results_chordcounter_pkey", x => x.id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_done = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ...
                    content_encoding = table.Column<string>(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("django_celery_results_groupresult_pkey", x => x.id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    task_name = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    worker = table.Column<string>(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("django_celery_results_taskresult_pkey", x => x.id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    session_key = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    storage_hash = table.Column<string>(
                        type: "character varying(40)",
                        maxLength: 40,
                        nullable: false
                    ),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("easy_thumbnails_source_pkey", x => x.id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorTime = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ExecutionPointerId = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    Message = table.Column<string>(type: "text", nullable: true),
                    WorkflowId = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribeAsOf = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false,
                    ...
                    ExternalToken = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
                    ExternalTokenExpiry = table.Column<DateTime>(
                        type: "timestamp without time zone",
                        nullable: true
                    ),
                    ExternalWorkerId = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowDefinitionId = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "dynamic_preferences_users_userpreferencemodel_pkey",
                        x => x.id
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    action_time = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    object_id = table.Column<string>(type: "text", nullable: true),
                    object_repr = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SleepUntil = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    PredecessorId = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    playlist_id = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: false
                    ),
                    ...
                    download_order = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: true
                    ),
                    automatically_delete_watched = table.Column<bool>(
                        type: "boolean",
                        nullable: true
                    ),
                    parent_folder_id = table.Column<int>(
                        type: "integer",
                        nullable: false,
                        defaultValue: 0
                    ),
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    channel_id = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: false
                    ),
                    channel_name = table.Column<string>(
                        type: "character varying(1024)",
                        maxLength: 1024,
                        nullable: false
                    ),
                    rewrite_playlist_indices = table.Column<bool>(type: "boolean", nullable: false),
                    last_synchronised = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeKey = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    uploader_name = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "auth_group_permissions");

            migrationBuilder.DropTable(name: "auth_user_groups");

            migrationBuilder.DropTable(name: "auth_user_user_permissions");

            migrationBuilder.DropTable(name: "AuthProviders");

            migrationBuilder.DropTable(name: "django_admin_log");

            migrationBuilder.DropTable(name: "django_celery_results_chordcounter");

            migrationBuilder.DropTable(name: "django_celery_results_groupresult");

            migrationBuilder.DropTable(name: "django_celery_results_taskresult");

            migrationBuilder.DropTable(name: "django_migrations");

            migrationBuilder.DropTable(name: "django_session");

            migrationBuilder.DropTable(name: "dynamic_preferences_globalpreferencemodel");

            migrationBuilder.DropTable(name: "dynamic_preferences_users_userpreferencemodel");

            migrationBuilder.DropTable(name: "easy_thumbnails_thumbnaildimensions");

            migrationBuilder.DropTable(name: "Event", schema: "wfc");

            migrationBuilder.DropTable(name: "ExecutionError", schema: "wfc");

            migrationBuilder.DropTable(name: "ExtensionAttribute", schema: "wfc");

            migrationBuilder.DropTable(name: "ScheduledCommand", schema: "wfc");

            migrationBuilder.DropTable(name: "Subscription", schema: "wfc");

            migrationBuilder.DropTable(name: "YtManagerApp_jobmessage");

            migrationBuilder.DropTable(name: "YtManagerApp_video");

            migrationBuilder.DropTable(name: "auth_group");

            migrationBuilder.DropTable(name: "auth_permission");

            migrationBuilder.DropTable(name: "easy_thumbnails_thumbnail");

            migrationBuilder.DropTable(name: "ExecutionPointer", schema: "wfc");

            migrationBuilder.DropTable(name: "YtManagerApp_jobexecution");

            migrationBuilder.DropTable(name: "YtManagerApp_subscription");

            migrationBuilder.DropTable(name: "django_content_type");

            migrationBuilder.DropTable(name: "easy_thumbnails_source");

            migrationBuilder.DropTable(name: "Workflow", schema: "wfc");

            migrationBuilder.DropTable(name: "YtManagerApp_subscriptionfolder");

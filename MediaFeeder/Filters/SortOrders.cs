...
{
    public static IQueryable<Video> SortVideos(
        this IQueryable<Video> source,
        ...
        sortOrder switch
        {
            ...
            SortOrders.ReversePlaylistOrder => source.OrderByDescending(static v =>
                v.PlaylistIndex
            ),
            ...
            SortOrders.WatchedRecently => source
                .Where(static v => v.WatchedDate != null)
                .OrderByDescending(static v => v.WatchedDate),
            SortOrders.WatchedHistorically => source
                .Where(static v => v.WatchedDate != null)
                .OrderBy(static v => v.WatchedDate),
            SortOrders.StaredRecently => source
                .Where(static v => v.Star)
                .OrderByDescending(static v => v.StarDate),
            SortOrders.StaredHistorically => source
                .Where(static v => v.Star)
                .OrderBy(static v => v.StarDate),
            _ => source,
        };
    ...
    public static IQueryable<Video> SortVideos(
        ...
        downloadOrder switch
        {
            ...
            DownloadOrder.ReversePlaylistOrder => source.OrderByDescending(static v =>
                v.PlaylistIndex
            ),

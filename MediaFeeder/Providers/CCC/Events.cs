...
public record Event
{
    ...
    public string[] Persons { get; init; } = [];
    ...
    [JsonPropertyName("thumbnails_url")]
    public Uri? ThumbnailsUrl { get; init; }

    [JsonPropertyName("frontend_link")]
    public Uri? FrontendLink { get; init; }

    [JsonPropertyName("url")]
    public Uri? Url { get; init; }

    [JsonPropertyName("conference_title")]
    public string? ConferenceTitle { get; init; }

    [JsonPropertyName("conference_url")]
    public Uri? ConferenceUrl { get; init; }

    [JsonPropertyName("related")]
    public object[] Related { get; init; } = [];
